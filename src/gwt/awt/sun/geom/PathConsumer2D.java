...
package gwt.awt.sun.geom;

public interface PathConsumer2D {
    /**
     * @see gwt.awt.geom.Path2D.Float.moveTo
     */
    public void moveTo(float x, float y);

    /**
     * @see gwt.awt.geom.Path2D.Float.lineTo
     */
    public void lineTo(float x, float y);

    /**
     * @see gwt.awt.geom.Path2D.Float.quadTo
     */
    public void quadTo(float x1, float y1,
                       float x2, float y2);

    /**
     * @see gwt.awt.geom.Path2D.Float.curveTo
     */
    ...
    /**
     * @see gwt.awt.geom.Path2D.Float.closePath
     */
     ...
     * {@link gwt.awt.geom.PathIterator PathIterator}
